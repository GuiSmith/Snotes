...
<form action = "edit_note/edit_note_validation.php" method = "POST"  class = "box-content box-form box-editor box-center" autocomplete = "off" onsubmit = "return confirmSubmit()" >
