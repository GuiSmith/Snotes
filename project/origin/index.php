...
<section class = "row" >
	<div class = "col-sm-8" >
		<div class = "box-content box-center box-text" >
			...
			<p>Meu estímulo veio do sentimento de querer sempre fazer um pouco a cada dia, sejam cem lihas de código ou apenas uma, seja uma tela inteira ou um botão. Ir dormir sabendo que avancei em conhecimento e desenvolvimento de meu próprio projeto não tem preço. Nem sempre estamos fazendo o que podemos para melhorar nosso futuro eu, então meu maior estímulo eram coisas que não contribuem para meu desenvolvimento pessoal. Pois me lembrava de onde eu realmente deveria estar.</p>
			
		</div>
	</div>
	<div class = "col-sm-4 text-center" >
		<img src = "media/lamp.png" width = "50%">
	</div>
</section>
<aside class = "row" >
	<div class = "col-sm-5" >
		<div class = "box-content box-center" >
			<iframe width="320" height="550" src="https://www.youtube.com/embed/0iUf8UJSGwc" title="Can&#39;t End on a Loss" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
		</div>
	</div>
	<div class = "col-sm-7" class="text-center" >
		<div class = "box-content box-center box-text" >
			...
			<img src = "media/gamer.png" style = "height: 250px;">
		</div>
	</div>
</aside>
